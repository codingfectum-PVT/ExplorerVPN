...
const FAQItem = styled(Box)`
  background-color: ${({ open }) => (open ? '#FFFFFF' : '#E7ECF0')}; 
  border-radius: 10px;
      ...
      <Container maxWidth="xl">
        <Grid container justifyContent={'center'} textAlign={'center'}>
          <Grid item xs={12}>
            ...
            <Typography variant="h2" sx={{ color: '#171717', fontWeight: '600', fontSize: { xs: '28px', sm: '32px', md: '61px' }, marginBottom: '30px' }} >
              Asked Questions
            </Typography>
           <img src={line} alt='line' style={{width:'100%',maxWidth:'250px',height:'auto',marginBottom:'30px'}}/>
          </Grid>
